...
fit <- reservoir::reservoirR_fit(node = model, X = lsdf$xTrain, Y = lsdf$yTrain, warmup = 30, reset = TRUE)
```
...
vec_pred <- reservoir::predict_seq(node = fit$fit, X = lsdf$xTest, reset = TRUE)
```
