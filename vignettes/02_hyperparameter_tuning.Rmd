...
random_search_hyperparam(
  ...
  ls_fct = list(
    ridge = function(n)
      PredictCovid::rloguniform(n = n, min = 1e-10, max = 1e-1),
    input_scaling = function(n)
      1,
    spectral_radius = function(n)
      PredictCovid::rloguniform(n = n, min = 1e-10, max = 1e5),
...
dfHyperparam <- random_search_hyperparam(n = 30,
                                                       ls_fct = list(ridge = function(n) PredictCovid::rloguniform(n = n, min = 1e-10, max = 1e-1),
                                                                     input_scaling = function(n) PredictCovid::rloguniform(n = n, min = 1e-5, max = 1e2),
                                                                     spectral_radius = function(n) PredictCovid::rloguniform(n = n, min = 1e-5, max = 1e2),
...
dfHyperparam <- random_search_hyperparam(n = 30,
                                                       ls_fct = list(ridge = function(n) PredictCovid::rloguniform(n = n, min = 1e-10, max = 1e-1),
                                                                     ...
                                                                     leaking_rate = function(n) PredictCovid::rloguniform(n = n, min = 1e-3, max = 1))) %>%
  # replicate 2 times
  replicate(n = 2, simplify = FALSE) %>%
  bind_rows() %>%
  tibble::rowid_to_column(var = "search_id_master")
